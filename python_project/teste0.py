...
# =============================================================================
                                            ...
                                            while n == 0:
                                                ...
                                                if x != None:
                                                    ...
                                                    time.sleep(15)
                                                    pyautogui.click((1067,137), interval = 1)
                                                    time.sleep(3)
                                                    pyautogui.click((350,266), interval = 1)
                                                    time.sleep(2)
                                                    pyautogui.click((351,417), interval = 1)
                                                    pyautogui.press('pagedown')
                                                    pyautogui.press('pagedown')
                                                    pyautogui.press('pagedown')
                                                    pyautogui.press('pagedown')
                                                    time.sleep(2)
                                                    pyautogui.click((372,419), interval = 1)
                                                    time.sleep(2)
                                                    pyautogui.click((1269,696), interval = 1)
                                                    time.sleep(2)
                                                    pyautogui.press('pagedown')
                                                    pyautogui.press('pagedown')
                                                    pyautogui.press('pagedown')
                                                    pyautogui.press('pagedown')
                                                    pyautogui.click((627,580), interval = 1)
                                                    time.sleep(5)
                                                    o = 0
                                                    ...
                                                    while o == 0:
                                                        ...
                                                        if convert_im3 == [(1, (255, 255, 255))] and convert_im4 == [(1, (237, 237, 239))]:
                                                            print("hello world")
                                                            pyautogui.click((923,23), interval = 2)
